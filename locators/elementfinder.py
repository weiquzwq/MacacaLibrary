...
class ElementFinder(object):
    ...
    def _find_by_id(self, browser, criteria, tag, constraints):
        return self._filter_elements(
            browser.element_by_id(criteria),
            tag, constraints)
    ...
    def _find_by_xpath(self, browser, criteria, tag, constraints):
        ...
        return self._filter_elements(
            browser.element_by_xpath(criteria),
            tag, constraints)
    ...
    def _find_by_key_attrs(self, browser, criteria, tag, constraints):
        logger.write('_find_by_key_attrs',level='INFO', html=False)
        ...
        return self._normalize_result(browser.element_by_xpath(xpath))       # 原find_elements_by_xpath
    ...
    def _normalize_result(self, elements):
        elementlist=[]
        #logger.write("elements", level='INFO', html=False)
