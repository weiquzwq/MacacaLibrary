...
class _ScreenshotKeywords(KeywordGroup):
    ...
    def capture_page_screenshot(self, filename=None):
        ...
        `macaca-screenshot-<counter>.png` under the directory where
        ...
        if hasattr(self._current_application(), 'take_screenshot'):
            self._current_application().take_screenshot()
    ...
    def _get_screenshot_paths(self, filename):
        if not filename:
            ...
            filename = 'macaca-screenshot-%d.png' % self._screenshot_index
        else:
